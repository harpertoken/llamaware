...
# Install locally
install: build
	@echo "Installing Agentware Agent locally..."
	@sudo cp build/bin/agentware-agent /usr/local/bin/
	@echo "Installation complete. Run 'agentware-agent' to start."
...
# Show help
help:
	@echo "Agentware Agent - Available Make Targets:"
	@echo ""
	@echo "Build Commands:"
