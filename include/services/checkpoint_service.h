...
namespace Services {
    ...
    private:
        ...
        static std::vector<std::string> get_project_files(const std::string& directory);
        static void backup_file(const std::string& source_path, const std::string& backup_path);
        static void restore_file(const std::string& backup_path, const std::string& target_path);
        
    public:
        // Create checkpoint
        static std::string create_checkpoint(
        ...
        static bool restore_checkpoint(
        ...
        static bool export_checkpoint(const std::string& checkpoint_id, const std::string& export_path);
