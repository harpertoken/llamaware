...
namespace Services {
    ...
    public:
        ...
        static bool create_sandbox_config(const std::string& name, const SandboxConfig& config);
        ...
        // Command execution
        static SandboxResult execute_command(const std::string& command, 
                                           const std::string& sandbox_name = "default",
                                           const std::string& working_dir = "");
        static SandboxResult execute_script(const std::string& script_content,
                                          const std::string& script_type,
                                          const std::string& sandbox_name = "default");
        static SandboxResult execute_file(const std::string& file_path,
                                        const std::string& sandbox_name = "default");
        ...
        static bool validate_sandbox_config(const SandboxConfig& config, std::string& error_message);
        static std::vector<std::string> get_security_warnings(const std::string& command);
        
        // Configuration management
        static bool save_sandbox_config();
        static bool load_sandbox_config();
        static bool update_sandbox_limits(const std::string& name, size_t memory_mb, size_t cpu_percent);
